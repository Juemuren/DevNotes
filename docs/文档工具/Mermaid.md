...
>
> 不过上述扩展虽然是官方扩展，但口碑不太好，可以尝试使用社区扩展的组合
>
> - [Markdown Preview Mermaid Support](https://marketplace.visualstudio.com/items?itemName=bierner.markdown-mermaid) 在 Markdown 中预览 Mermaid 图表
