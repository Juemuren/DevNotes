...
- 不太适合高度结构化的内容。Hugo 相对而言更适合 *博客* 而不是 *文档*，也就是说你的网站应该由一篇篇联系相对松散的文章组成，而不是一本有清晰的章节、能够整理出目录的书籍。虽然说 Hugo 也有适合文档的主题，但使用最多的还是那些用来搭建 *博客* 的主题。

由于我希望我的笔记的内容是高度结构化的，并且不太在意构建速度，因此我为这个网站选择了 MkDocs。
